...
$messages['ast'] = array(
	...
	'foxway-php-fatal-error-cannot-break-continue' => 'Error fatal de PHP: Nun puen interrumpise/continuase $1 niveles na páxina $2 llinia $3.',
	'foxway-php-fatal-error-max-execution-time' => "Error fatal de PHP: Superóse'l tiempu máximu d'execución de $1 segundos na páxina $2.",
	'foxway-php-fatal-error-max-execution-time-scope' => "Error fatal de PHP: Superóse'l tiempu máximu d'execución de $1 segundos na páxina $2 na llinia $3.",
...
$messages['de'] = array(
	...
	'foxway-php-fatal-error-max-execution-time' => 'Fataler PHP-Fehler: Maximale Ausführungszeit von {{PLURAL:$1|einer Sekunde|$1 Sekunden}} auf Seite $2 überschritten.',
...
$messages['gl'] = array(
	...
	'foxway-php-fatal-error-max-execution-time' => 'Erro fatal de PHP: Superouse o número máximo de {{PLURAL:$1|$1 segundo|$1 segundos}} de execución na páxina "$2".',
...
$messages['ja'] = array(
	...
	'foxway-php-fatal-error-max-execution-time' => 'PHP 致命的エラー: ページ $2 の実行時間が最大値の {{PLURAL:$1|$1 秒}}を超えました。',
...
$messages['mk'] = array(
	...
	'foxway-php-fatal-error-max-execution-time' => 'Кобна грешка во PHP: Надминат е рокот од $1 {{PLURAL:$1|$1 секунда|$1 секунди}} за извршување на наредбата на страницата $2.',
...
$messages['uk'] = array(
	...
	'foxway-php-fatal-error-max-execution-time' => 'PHP фатальна помилка: максимальний час виконання з  {{PLURAL:$1|$1 секунда|$1 секунди|$1 секунд|$1 секунди}} перевищений на сторінці $2.',
