...
echo "$a, ", $a++ + -5, ", " . ++$a, ", $a.";'),
	...
	public function testRun_echo_math_Increment_4() {
		$this->assertEquals(
				Interpreter::run('$a=2; $b=10; $c=30; echo $a + $b * $a++;'),
				array('23')
				);
	}
...
",
	...
	public function testRun_while_1() {
		$this->assertEquals(
				Interpreter::run('$i=1; while( $i <= 3 ) { echo $i++; }'),
				array('1', '2', '3')
				);
	}
	...
	public function testRun_while_continue_1() {
		$this->assertEquals(
				Interpreter::run('$i=1; while( $i <= 3 ) { echo $i++; continue; $i++ }'),
				array('1', '2', '3')
				);
	}
	public function testRun_while_break_1() {
		$this->assertEquals(
				Interpreter::run('$i=1; while( $i <= 33 ) { echo $i++; break; $i++ }'),
				array('1')
				);
	}
	public function testRun_while_if_continue_1() {
		$this->assertEquals(
				Interpreter::run('$i=0; while( $i <= 2 ) { $i++; if($i == 2) continue; echo $i; }'),
				array('1', '3')
				);
	}
	public function testRun_while_if_continue_2() {
		$this->assertEquals(
				Interpreter::run('$i=0; while( $i <= 2 ) { $i++; if($i == 2) { echo "Two"; continue; } echo $i; }'),
				array('1', 'Two', '3')
				);
	}
	public function testRun_while_if_break_1() {
		$this->assertEquals(
				Interpreter::run('$i=1; while( $i <= 33 ) { echo $i++; if($i == 3) break; }'),
				array('1', '2')
				);
	}
	public function testRun_while_if_break_2() {
		$this->assertEquals(
				Interpreter::run('$i=1; while( $i <= 33 ) { echo $i++; if($i == 3){echo "The end"; break; echo "anything";} }'),
				array('1', '2', 'The end')
				);
	}
	public function testRun_while_while_1() {
		$this->assertEquals(
				implode( Interpreter::run('$i=1; while( $i<=3 ){ echo "|$i|"; $y=1; while( $y<=$i ){ echo "($y)"; $y++; } $i++; }') ),
				'|1|(1)|2|(1)(2)|3|(1)(2)(3)'
				);
	}
	public function testRun_while_while_continue_1() {
		$this->assertEquals(
				implode( Interpreter::run('$i=1; while( $i<=3 ){ echo "|$i|"; $y=0; while( $y<3 ){ $y++; if( $y==2) continue; echo "($y)";  } $i++; }') ),
				'|1|(1)(3)|2|(1)(3)|3|(1)(3)'
				);
	}
	public function testRun_while_while_continue_2() {
		$this->assertEquals(
				implode( Interpreter::run('$i=0; while( $i<5 ){ $i++; echo "|$i|"; $y=0; while( $y<3 ){ $y++; if( $y==$i ){ continue 2; } echo "($y)";  } }') ),
				'|1||2|(1)|3|(1)(2)|4|(1)(2)(3)|5|(1)(2)(3)'
				);
	}
	public function testRun_while_while_break_1() {
		$this->assertEquals(
				implode( Interpreter::run('$i=1; while( $i<=5 ){ echo "|$i|"; $y=0; while( $y<3 ){ $y++; if( $y==2) break; echo "($y)";  } $i++; }') ),
				'|1|(1)|2|(1)|3|(1)|4|(1)|5|(1)'
				);
	}
	public function testRun_while_while_break_2() {
		$this->assertEquals(
				implode( Interpreter::run('$i=1; while( $i<=5 ){ echo "|$i|"; $y=0; while( $y<4 && $y<$i ){ $y++; if( $y==3) { break 2; echo "hohoho"; } echo "($y)";  } $i++; }') ),
				'|1|(1)|2|(1)(2)|3|(1)(2)'
				);
	}
	public function testRun_while_if_while_1() {
		$this->assertEquals(
				implode( Interpreter::run('$i=1; while( $i<=5 ){ echo "|$i|"; $y=0; if( $i==2 || $i == 4 ) while( $y<$i ){ $y++; echo "($y)"; } $i++; } ') ),
				'|1||2|(1)(2)|3||4|(1)(2)(3)(4)|5|'
				);
	}
	public function testRun_while_if_while_2() {
		$this->assertEquals(
				implode( Interpreter::run('$i=1; while( $i<=5 ){ echo "|$i|"; $y=0; if( $i==2 || $i == 4 ) { echo "."; while( $y<$i ){ $y++; echo "($y)"; } } $i++; } ') ),
				'|1||2|.(1)(2)|3||4|.(1)(2)(3)(4)|5|'
				);
	}
	public function testRun_while_if_while_if_1() {
		$this->assertEquals(
				implode( Interpreter::run('$i=1; while( $i<=5 ){ echo "|$i|"; $y=0; if( $i==2 || $i == 4 ) { echo "."; while( $y<$i ){ $y++; if($y < 3) echo "($y)"; else break 2; } } $i++; } ') ),
				'|1||2|.(1)(2)|3||4|.(1)(2)'
				);
	}
