...
echo isset($expected_array_got_string[0]) ? "true" : "false";')
	...
	public function testRun_constant_test_banned() {
		...
		$this->assertEquals(
			array( (string)$exc1, (string)$exc2, false ),
			$result
		);
	}
